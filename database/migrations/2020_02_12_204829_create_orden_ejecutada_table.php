...
class CreateOrdenEjecutadaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orden_ejecutada', function (Blueprint $table) {
            ...
            $table->string('oposicion',50);
            $table->string('sin_caja',50);
            $table->string('sin_tapa',50);
            $table->string('fuga_antes',50);
            $table->string('fuga_despues',50);
            $table->string('talco_roto',50);
            $table->string('posible_fraude',50);
            $table->string('mtl',50);
            ...
            $table->string('foto4',255);
            $table->string('foto5',255);
